      ...
      <section className="min-h-screen flex items-center justify-center relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          ...
          >
            ...
            >
              <a href="https://maps.app.goo.gl/3vydLZtp9DR4FopQ8">
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Espero você na Estação 183 em Parobé! Confira mais informações abaixo:
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                title: "Data",
                description: "Sábado, dia 09 de Agosto de 2025, 22:30",
                icon: "📅",
              },
              {
                title: "Endereço",
                description: "Rua: João Mosmann, N°: - Centro, Parobé - RS, 95630-000",
                icon: "🎈",
              },
              {
                title: "Janta",
                description: "Estação 183 Parobé",
                icon: "😋",
              },
            ].map((service, index) => (
              <motion.div
